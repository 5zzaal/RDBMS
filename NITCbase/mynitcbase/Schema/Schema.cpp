...
int Schema::renameRel(char oldRelName[ATTR_SIZE], char newRelName[ATTR_SIZE])
{
    ...
    if(strcmp(oldRelName,(char*)RELCAT_RELNAME)==0 ||strcmp(newRelName,(char*)RELCAT_RELNAME)==0||strcmp(oldRelName,(char*)ATTRCAT_RELNAME)==0||strcmp(newRelName,(char*)ATTRCAT_RELNAME)==0){
      return E_NOTPERMITTED;
    }
